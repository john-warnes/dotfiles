...
### Added
- Comprehensive AI coding agent instructions in `.github/copilot-instructions.md`
- Version management workflow documentation for AI agents
- Critical guidance on updating CHANGELOG.md and README.md during version changes
